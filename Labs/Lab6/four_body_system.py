...
#         -G*(m1*(x2-x1)/np.linalg.norm(x2-x1)**3+m3*(x2-x3)/np.linalg.norm(x2-x3)**3+m4*(x2-x4)/np.linalg.norm(x2-x4)**3),
#         -G*(m1*(x3-x1)/np.linalg.norm(x3-x1)**3+m2*(x3-x2)/np.linalg.norm(x3-x2)**3+m4*(x3-x4)/np.linalg.norm(x3-x4)**3),
